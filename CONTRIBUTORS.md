...
Список контрибьютеров данного проекта доступен по ссылке https://github.com/enb-bem/enb-bem-i18n/graphs/contributors.
...
Если вы что-то исправили или добавили в пакет `enb-bem-i18n`, вы можете отправить пулл-реквест. Он будет рассмотрен мейнтейнером и, либо принят, либо прокомментирован для дальнейшей доработки, либо отклонен.

Ошибки
------

Если вы нашли ошибку, недоделку, опечатку и вообще любой дефект в `enb-bem-i18n`, пожалуйста, сообщите об этом, используя github-issues.
...
Если вы придумали новую фичу, весьма вероятно, что её реализацию вам придётся писать самому. Но вы не постесняйтесь, спросите у ментейнеров имена разработчиков, которые хорошо разбираются в `enb-bem-i18n` — с ними можно скооперироваться, чтобы реализовать вашу задумку.
